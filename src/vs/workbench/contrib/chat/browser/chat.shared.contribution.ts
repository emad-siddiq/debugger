...
// burrow(WO-80, patch 0015): see the disabled ChatStatusBarEntry registration below.
...
// burrow(WO-80, patch 0015): the "$(copilot) Sign In" status entry and its dashboard
// assume product.defaultChatAgent, which Burrow no longer ships.
