...
// looks like in that codebase, so generated requests carry values the developer
// would have typed anyway ("eth-mainnet-01", not "name").
//
...
// behaviour exactly.
//
// TWIN: extensions/burrow-db/src/seedProfile.ts is a deliberate copy — the two
