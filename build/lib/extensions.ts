...
// Burrow (task 02 strip): entries for deleted extensions (ipynb, markdown-math,
// mermaid-markdown-features, notebook-renderers, simple-browser) are removed in
// lockstep with their dirs — a stale entry points esbuild at a missing .mts and
// fails `compile-extension-media`. Only kept markdown-language-features remains.
