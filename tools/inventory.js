...
const DECISIONS = {
  ...
  'python': { action: 'remove', via: 'd', why: 'non-Go language' },
  ...
  'rust': { action: 'remove', via: 'd', why: 'non-Go language' },
  ...
  'typescript-basics': { action: 'remove', via: 'd', why: 'TS grammar — not in Go repos (JS grammar kept)' },
